...
- [Yan, M., et al. (2024). "Mobile phone short video use negatively impacts attention functions: an EEG study." *Frontiers in Human Neuroscience* (PMC11236742)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC11236742/) — EEG study finding r = −0.395 correlation between short-form video addiction and reduced prefrontal theta power during executive control tasks.

- [Barton, A., & Smyth, M. (2025). "Context-switching in short-form videos: What is the impact on prospective memory?" *Memory*](https://doi.org/10.1080/09658211.2025.2521076) — Rapid context-switching in TikTok-style consumption impairs prospective memory formation.
